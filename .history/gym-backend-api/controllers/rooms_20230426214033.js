...
roomController.post("/rooms/", validate({ body: createRoomSchema }), (req, res) => {
...
// XML upload
roomController.post("/rooms/upload/xml", auth(["admin", "trainer"]), (req, res) => {
    if (req.files && req.files["xml-file"]) {
        ...
        parser.parseStringPromise(file_text)
            .then(data => {
                ...
                const roomsData = roomUpload["activities"][0]["activity"]
