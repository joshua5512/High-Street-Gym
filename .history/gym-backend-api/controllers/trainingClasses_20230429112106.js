...
classController.get("/classes", validate({ body: getClassListSchema }), async (req, res) => {
...
classController.get("/classes/user-id/:id", validate({ params: getClassByUserIDSchema }), async (req, res) => {
    // #swagger.summary = 'Get a specific class by user ID'
    const userID = req.params.id
    const trainingClasses = await models.classModel.getUserClasses(userID).then(trainingClasses => {
        res.status(200).json({
            status: 200,
...
classController.get("/classes/:id", validate({ params: getClassByIDSchema }), (req, res) => {
...
classController.post("/classes/", validate({ body: createClassSchema }), (req, res) => {
...
classController.patch("/classes/", validate({ body: updateClassSchema }), (req, res) => {
...
classController.delete("/classes/", validate({ body: deleteClassSchema }), (req, res) => {
