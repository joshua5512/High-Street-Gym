...
//         fetch(API_URL + "/activities/upload/xml?authKey=" + user.authenticationKey,
//             {
//                 method: "POST",
//                 body: formData,
//             })
...
export function XMLUpload({ endpoint, onUploadSuccess }) {
    const [user] = useAuthentication()
    ...
    function uploadFile(e) {
        ...
        fetch(endpoint + "?authKey=" + user.authenticationKey,
            {
                method: "POST",
                body: formData,
            })
