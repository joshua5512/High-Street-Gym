...
export default function Blogposts({ refreshDependency }) {
  ...
  return (
    <>
      <Nav />
  <div className="container p-2 mx-auto flex items-center justify-center h-screen overflow-y-auto mt-16">
    <div className="rounded border-2 border-primary p-2 w-3/4 mx-auto">
      {blogposts.length === 0 ? (
        <Spinner />
      ) : (
