...
function Dashboard() {
    ...
    return <>
        <Nav />
{user ?
    <div className={`container p-2 mt-16 mx-auto grid grid-cols-1 ${user.role === "admin" ? "md:grid-cols-2" : "md:grid-cols-3"} gap-2`}>
        ...
        <div className={`rounded border-2 border-primary ${user.role === "admin" ? "md:col-start-1" : "md:col-start-2"} min-h-16 p-2`}>
