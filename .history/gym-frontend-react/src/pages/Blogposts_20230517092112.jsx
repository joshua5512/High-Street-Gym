...
export default function Blogposts({ refreshDependency }) {
  ...
  return (
    <>
      <Nav />
      <div className="container p-2 mt-16 mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 w-full md:w-3/4">
        <div className="rounded-2xl border-2 border-primary p-2 w-full md:w-3/4">
          {blogposts.length === 0 ? (
            <Spinner />
          ) : (
