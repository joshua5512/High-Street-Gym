      ...
      <div className="container p-2 mx-auto">
        <div className="rounded border-2 border-primary p-2 w-full">
              ...
              <tbody>
                {blogposts.map((blogpost, index) => (
                  <tr key={blogpost.id}>
                    ...
                    <td>
                      {expanded || index < 3 ? (
                        <div className="content-wrapper">{blogpost.content}</div>
                      ) : (
                        <div className="content-wrapper">{blogpost.content.slice(0, 100)}...</div>
                      )}
                    </td>
                    <td>
          ...
          {user && (
            <div className="mt-4">
              <Link
 to="/blogposts/create" className="btn btn-primary">
                Create New Blogpost
              </Link>
            </div>
          )}
