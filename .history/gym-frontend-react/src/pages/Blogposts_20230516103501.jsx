...
export default function Blogposts({ refreshDependency }) {
  ...
  return (
    <>
      <Nav />
      <div className="container items-center flex justify-center h screen p-2 mt-16  mx-auto">
        <div className="rounded-2xl border-2 border-primary p-2 w-3/4 ">
        {blogposts.length === 0 ? (
  <Spinner />
) : (
  <div className="flex flex-col space-y-4">
     {user && (
            <div className="mt-4">
              <Link to="/blogposts/create" className="btn btn-primary items-right">
                Create New Blogpost
              </Link>
            </div>
          )}
