...
export default function CreateBlogpost() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/blogposts/create"); // Redirect to the blog posts list page after successful creation
    } catch (error) {
      ...
      <div className="container p-2 mx-auto">
        <div className="rounded border-2 border-primary p-2 w-full">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-2">
              <button type="submit" className="btn btn-primary py-1 mr-2">
                Create
              </button>
              <button
                    className="btn btn-secondary"
                    onClick={() => navigate("/blogposts")}>Back
                    </button>
            </div>
          </form>
        </div>
